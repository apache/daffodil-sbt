  ...
  override lazy val projectSettings: Seq[Setting[_]] = Seq(
    ...
    libraryDependencies ++= {
      if (daffodilBuildsCharset.value) {
        val charsetDep = Map(
          ">=4.0.0 " -> "org.apache.daffodil" % "daffodil-core_3" % daffodilVersion.value % "provided",
          "=3.11.0 " -> "org.apache.daffodil" % "daffodil-io_2.13" % daffodilVersion.value % "provided",
          "<=3.10.0 " -> "org.apache.daffodil" % "daffodil-io_2.12" % daffodilVersion.value % "provided"
        )
    ...
    libraryDependencies ++= {
      if (daffodilBuildsLayer.value) {
        val charsetDep = Map(
          ">=4.0.0 " -> "org.apache.daffodil" % "daffodil-core_3" % daffodilVersion.value % "provided",
          "=3.11.0 " -> "org.apache.daffodil" % "daffodil-runtime1-layers_2.13" % daffodilVersion.value % "provided",
          "<=3.10.0 " -> "org.apache.daffodil" % "daffodil-runtime1-layers_2.12" % daffodilVersion.value % "provided"
        )
        filterVersions(daffodilVersion.value, charsetDep)
      } else {
        Seq()
